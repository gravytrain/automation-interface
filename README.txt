Start VirtualHub with System V (Ubuntu, debian, Raspbian...)
=========================================================================
- 1: copy the VirtualHub binary to the directory /usr/sbin/
- 2: ensure that the /usr/sbin/Virtualhub is executable with :
    # chmod +x /usr/sbin/VirtualHub
- 3: copy the the file startup_script/yVirtualHub to /etc/init.d/
    # cp startup_script/yVirtualHub /etc/init.d/
- 4: ensure that the /etc/init.d/yVirtualhub is executable with :
